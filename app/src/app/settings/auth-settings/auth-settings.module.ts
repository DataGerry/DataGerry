...
import { EntraIdAuthenticationProviderFormComponent } from './providers/entraid-authentication-provider-form/entraid-authentication-provider-form.component';
/* ------------------------------------------------------------------------------------------------------------------ */
...
@NgModule({
    declarations: [
        ...
        EntraIdAuthenticationProviderFormComponent
    ],
    imports: [
        CommonModule,
