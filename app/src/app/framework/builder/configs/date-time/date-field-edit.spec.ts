...
/**
 * Verifies the ngModelChange -> valueChanges migration for the date field builder,
 * and that resetDate() clears the value silently ({ emitEvent: false }).
 */
...
describe('DateFieldEditComponent', () => {
    ...
    it('should register every form control on ngOnInit', () => {
        ['required', 'name', 'label', 'description', 'value', 'helperText', 'hideField']
    ...
    it('should propagate the text control edits through valueChanges', fakeAsync(() => {
        const cases: Array<{ control: keyof DateFieldEditComponent; type: string; value: string }> = [
            { control: 'labelControl', type: 'label', value: 'Created on' },
            { control: 'descriptionControl', type: 'description', value: 'A date' },
            { control: 'valueControl', type: 'value', value: '2026-07-08' },
        ...
        cases.forEach(({ control, type, value }) => {
            ...
            expect(relevant[0].elementType).toBe('date');
        });
    ...
    it('should not emit field changes during initialization', () => {
        const fresh = TestBed.createComponent(DateFieldEditComponent).componentInstance;
    ...
    it('should disable the name control in edit mode', () => {
        const editComponent = TestBed.createComponent(DateFieldEditComponent).componentInstance;
    ...
    it('should reset the value silently, without emitting a field change', fakeAsync(() => {
        component.valueControl.setValue('2025-01-01');

        const events = captureFieldChanges(component, () => component.resetDate());
    ...
    /* -------------------------------------- native input type toggles -------------------------------------- */

    it('should toggle the input type to text on double click', fakeAsync(() => {
    ...
    it('should change the input type back to date on focus out if type is text', () => {
    ...
    it('should stop propagating from every subscribed control after ngOnDestroy', fakeAsync(() => {
        ...
        const events = captureFieldChanges(component, () => {
            ...
            component.valueControl.setValue('2026-01-01');
