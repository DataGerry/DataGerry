...
export class NumberFieldEditComponent extends ConfigEditBaseComponent implements OnInit, OnDestroy {
    ...
    private toggleFormControls(disable: boolean) {
        ...
        if (disable) {
            ...
            this.regexControl.disable({ emitEvent: false });
            this.placeholderControl.disable({ emitEvent: false });
            ...
            this.regexControl.enable({ emitEvent: false });
            this.placeholderControl.enable({ emitEvent: false });
