...
class TestUnreadableTimestampsAreRefused:
    ...
    def test_an_unreadable_timestamp_raises(self) -> None:
        ...
        with pytest.raises(CmdbRackMountInitFromDataError):
            CmdbRackMount.from_data(_mount_data(creation_time='sometime in March'))
    ...
    def test_a_timestamp_string_is_still_read(self) -> None:
        ...
        built = CmdbRackMount.from_data(_mount_data(creation_time='2026-03-01T10:00:00'))
    ...
    def test_the_mongo_wrapper_shape_is_read_too(self) -> None:
        ...
        built = CmdbRackMount.from_data(_mount_data(creation_time={'$date': 1772000000000}))
