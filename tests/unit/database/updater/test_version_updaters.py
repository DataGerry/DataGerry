...
start_update logic of 20251203, the one updater whose whole migration is a single update_many_raw.
The remaining updaters' start_update is heavy I/O orchestration covered by their own unit suites and
