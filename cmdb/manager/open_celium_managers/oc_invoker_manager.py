...
GET_ALL_INVOKERS_URL: str = "/invoker/all"
...
# ---------------------------------------------------- CRUD - READ --------------------------------------------------- #
    ...
    def get_all_invokers(self) -> list[dict[str, Any]]:
        ...
        if all_invokers_response.status_code >= 200 and all_invokers_response.status_code < 300:
            return all_invokers_response.text
