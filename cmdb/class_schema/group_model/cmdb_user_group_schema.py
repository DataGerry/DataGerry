...
"""
Validation schema for CmdbUserGroup

A CmdbUserGroup is a group of CmdbUsers holding a set of rights; every user belongs to one
(collection ``management.groups``).

This module is the single source of the document's Cerberus validation schema,
consumed as CmdbUserGroup.SCHEMA.
"""
...
def get_cmdb_user_group_schema() -> dict[str, Any]:
    ...
    Returns:
        dict: Field name to Cerberus rule mapping, consumed as CmdbUserGroup.SCHEMA
    """
    return {
