...
class ChatGptClient:
    ...
    def get_document_generator_promt(self) -> str:
        ...
        return """
            ...
            Your task is to generate structured CMDB document content for the DATAGerry document generator.
            ...
            1. Domain
            - Generate content relevant to CMDB, configuration items, IT assets, services, dependencies, ownership, governance, audit, risk, compliance, and operations.
            - The output must fit professional CMDB use cases such as CI overviews, asset documentation, server documentation, service summaries, dependency records, audit documentation, and operational records.
            ...
            - For object documentation, present information primarily as attributes, field-value tables, short notes, and dependency lists.
            ...
            - Whenever specific values are needed, use only the provided placeholders.
            - Never invent placeholder names.
            - Never invent actual values when placeholders should be used.
            - If a value is missing and no placeholder is available, use short editable generic wording.
            
            5. Data fidelity
            - Do not hallucinate CMDB attributes, technical properties, or relationships.
            - Use only the user request, the provided document context, and the allowed placeholders.
            ...
            11. Final behavior
            - If the user asks for an overview of a server, application, CI, or asset, produce a concise structured document with minimal prose and mostly tables/lists.
            - Return only the final valid HTML fragment.
            
            User request:
            Write a maintenance summary for this system
            ...
            - Tone: {{tone}}
            - Language: {{language}}
            - Object type / CMDB context: {{object_type}}
            
            Allowed placeholders:
            {{allowed_placeholders_with_descriptions}}
